...
if dataset_name == 'places365_3c':
    ...
    class_list = ['bar','banquet_hall', 'beer_hall', 'cafeteria','coffee_shop', 'dining_hall', 'food_court', 'fastfood_restaurant','restaurant_patio','sushi_bar']
...
def image_data_3c():
    ...
    img_data = np.load(open(os.path.join('/home/zhaoy32/Desktop/understandingbdl/experiments/train/ckpts/places365_multiswag_3c/multiswag/image_data/image_'+str(image_id)+'_data.npy'),'rb'))
